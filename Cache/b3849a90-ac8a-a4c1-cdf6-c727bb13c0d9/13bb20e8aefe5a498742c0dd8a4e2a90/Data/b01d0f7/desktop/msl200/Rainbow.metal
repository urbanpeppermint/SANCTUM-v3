...
//float rotationAngle 4384
//float size 4388
//float speed 4392
//float3x3 opacityTexTransform 4448
//float4 opacityTexUvMinMax 4496
//float4 opacityTexBorderColor 4512
//float2 Port_Default_N024 4536
//float2 Port_Center_N048 4552
//float Port_Input1_N011 4564
//float depthRef 4572
//}
...
float2 l9_5=(*sc_set0.UserUniforms).Port_Default_N024;
ssGlobals l9_6=param_4;
float2 l9_7;
if (NODE_7_DROPLIST_ITEM_tmp==0)
{
float3 l9_8=float3(0.0);
l9_8=l9_6.SurfacePosition_ObjectSpace;
...
l9_12=l9_6.SurfacePosition_ObjectSpace;
float2 l9_13=float2(0.0);
l9_13=float2(l9_12.z,l9_12.x);
l9_4=l9_13;
l9_7=l9_4;
}
else
...
l9_1=l9_7;
float l9_14=0.0;
float l9_15=(*sc_set0.UserUniforms).rotationAngle;
l9_14=l9_15;
float l9_16=0.0;
l9_16=l9_14;
...
float2 l9_18=l9_1;
float l9_19=l9_16;
float2 l9_20=(*sc_set0.UserUniforms).Port_Center_N048;
float l9_21=sin(radians(l9_19));
float l9_22=cos(radians(l9_19));
float2 l9_23=l9_18-l9_20;
l9_23=float2(dot(float2(l9_22,l9_21),l9_23),dot(float2(-l9_21,l9_22),l9_23))+l9_20;
l9_17=l9_23;
float l9_24=0.0;
float l9_25=(*sc_set0.UserUniforms).size;
l9_24=l9_25;
float l9_26=0.0;
l9_26=l9_24;
float l9_27=0.0;
l9_27=l9_26*(*sc_set0.UserUniforms).Port_Input1_N011;
float2 l9_28=float2(0.0);
l9_28=l9_17*float2(l9_27);
float l9_29=0.0;
float l9_30=(*sc_set0.UserUniforms).speed;
l9_29=l9_30;
float l9_31=0.0;
l9_31=l9_29;
float l9_32=0.0;
l9_32=param_4.gTimeElapsed*l9_31;
float2 l9_33=float2(0.0);
l9_33=l9_28+float2(l9_32);
float4 l9_34=float4(0.0);
l9_34=float4(l9_33.x,1.0,1.0,1.0);
float4 l9_35=float4(0.0);
float3 l9_36=l9_34.xyz;
float3 l9_37=l9_36.zzz;
float l9_38=3.0*fract(l9_36.x+0.16666667);
float l9_39=2.0*fract(l9_38);
float l9_40=l9_36.y;
float l9_41=fast::clamp(l9_40,0.0,1.0);
float2 l9_42=l9_37.yz-((float2(1.0,l9_39)-float2(fast::max(0.0,l9_39-1.0)))*(l9_36.z*l9_41));
l9_37=float3(l9_37.x,l9_42.x,l9_42.y);
if (l9_38>=1.0)
{
l9_37=l9_37.zxy;
}
...
float3 l9_43=l9_37;
l9_35=float4(l9_43,l9_34.w);
float4 l9_44=float4(0.0);
l9_44=l9_35;
float2 l9_45=float2(0.0);
l9_45=param_4.Surface_UVCoord0;
...
int l9_52=l9_47;
int l9_53=opacityTexLayout_tmp;
int l9_54=l9_52;
float2 l9_55=l9_45;
bool l9_56=(int(SC_USE_UV_TRANSFORM_opacityTex_tmp)!=0);
float3x3 l9_57=(*sc_set0.UserUniforms).opacityTexTransform;
int2 l9_58=int2(SC_SOFTWARE_WRAP_MODE_U_opacityTex_tmp,SC_SOFTWARE_WRAP_MODE_V_opacityTex_tmp);
bool l9_59=(int(SC_USE_UV_MIN_MAX_opacityTex_tmp)!=0);
float4 l9_60=(*sc_set0.UserUniforms).opacityTexUvMinMax;
bool l9_61=(int(SC_USE_CLAMP_TO_BORDER_opacityTex_tmp)!=0);
float4 l9_62=(*sc_set0.UserUniforms).opacityTexBorderColor;
float l9_63=0.0;
...
if (l9_125==0)
{
l9_127=float3(l9_124,0.0);
}
else
{
if (l9_125==1)
{
l9_127=float3(l9_124.x,(l9_124.y*0.5)+(0.5-(float(l9_126)*0.5)),0.0);
}
else
{
l9_127=float3(l9_124,float(l9_126));
}
}
float3 l9_128=l9_127;
float3 l9_129=l9_128;
float4 l9_130=sc_set0.opacityTex.sample(sc_set0.opacityTexSmpSC,l9_129.xy,bias(l9_123));
float4 l9_131=l9_130;
if (l9_61)
{
l9_131=mix(l9_62,l9_131,float4(l9_65));
}
...
l9_134=float4(l9_44.xyz.x,l9_44.xyz.y,l9_44.xyz.z,l9_134.w);
l9_134.w=l9_133;
param_1=l9_134;
param_3=param_1;
}
...
float2 l9_139=(*sc_set0.UserUniforms).Port_Default_N024;
ssGlobals l9_140=param_4;
float2 l9_141;
if (NODE_7_DROPLIST_ITEM_tmp==0)
{
float3 l9_142=float3(0.0);
l9_142=l9_140.SurfacePosition_ObjectSpace;
float2 l9_143=float2(0.0);
l9_143=float2(l9_142.x,l9_142.y);
l9_136=l9_143;
l9_141=l9_136;
}
else
...
l9_144=l9_140.SurfacePosition_ObjectSpace;
float2 l9_145=float2(0.0);
l9_145=float2(l9_144.y,l9_144.z);
l9_137=l9_145;
l9_141=l9_137;
}
else
...
l9_146=l9_140.SurfacePosition_ObjectSpace;
float2 l9_147=float2(0.0);
l9_147=float2(l9_146.z,l9_146.x);
l9_138=l9_147;
l9_141=l9_138;
}
else
...
l9_135=l9_141;
float l9_148=0.0;
float l9_149=(*sc_set0.UserUniforms).rotationAngle;
l9_148=l9_149;
float l9_150=0.0;
l9_150=l9_148;
float2 l9_151=float2(0.0);
float2 l9_152=l9_135;
float l9_153=l9_150;
float2 l9_154=(*sc_set0.UserUniforms).Port_Center_N048;
...
l9_151=l9_157;
float l9_158=0.0;
float l9_159=(*sc_set0.UserUniforms).size;
l9_158=l9_159;
float l9_160=0.0;
l9_160=l9_158;
float l9_161=0.0;
l9_161=l9_160*(*sc_set0.UserUniforms).Port_Input1_N011;
float2 l9_162=float2(0.0);
l9_162=l9_151*float2(l9_161);
float l9_163=0.0;
float l9_164=(*sc_set0.UserUniforms).speed;
l9_163=l9_164;
float l9_165=0.0;
l9_165=l9_163;
float l9_166=0.0;
l9_166=param_4.gTimeElapsed*l9_165;
float2 l9_167=float2(0.0);
l9_167=l9_162+float2(l9_166);
float4 l9_168=float4(0.0);
l9_168=float4(l9_167.x,1.0,1.0,1.0);
float4 l9_169=float4(0.0);
float3 l9_170=l9_168.xyz;
float3 l9_171=l9_170.zzz;
float l9_172=3.0*fract(l9_170.x+0.16666667);
float l9_173=2.0*fract(l9_172);
float l9_174=l9_170.y;
float l9_175=fast::clamp(l9_174,0.0,1.0);
float2 l9_176=l9_171.yz-((float2(1.0,l9_173)-float2(fast::max(0.0,l9_173-1.0)))*(l9_170.z*l9_175));
l9_171=float3(l9_171.x,l9_176.x,l9_176.y);
if (l9_172>=1.0)
{
l9_171=l9_171.zxy;
}
...
float3 l9_177=l9_171;
l9_169=float4(l9_177,l9_168.w);
...
float4 l9_182=fast::max(param_6,float4(0.0));
float4 param_7=l9_182;
if (sc_ShaderCacheConstant_tmp!=0)
{
