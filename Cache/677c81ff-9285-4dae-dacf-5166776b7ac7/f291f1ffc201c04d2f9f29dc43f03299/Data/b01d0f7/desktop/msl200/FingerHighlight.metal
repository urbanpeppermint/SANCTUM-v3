...
//float3x3 handGlowTexTransform 4464
//float4 handGlowTexUvMinMax 4512
//float4 handGlowTexBorderColor 4528
//float4 thumbGlowColor 4544
//float thumbBrightness 4560
//float Port_Input0_N003 4564
//float Port_Input0_N011 4568
//float depthRef 4576
//}
...
int l9_6=l9_1;
int param_7=handGlowTexLayout_tmp;
int param_8=l9_6;
float2 param_9=UVCoord_N0;
bool param_10=(int(SC_USE_UV_TRANSFORM_handGlowTex_tmp)!=0);
float3x3 param_11=(*sc_set0.UserUniforms).handGlowTexTransform;
int2 param_12=int2(SC_SOFTWARE_WRAP_MODE_U_handGlowTex_tmp,SC_SOFTWARE_WRAP_MODE_V_handGlowTex_tmp);
bool param_13=(int(SC_USE_UV_MIN_MAX_handGlowTex_tmp)!=0);
float4 param_14=(*sc_set0.UserUniforms).handGlowTexUvMinMax;
bool param_15=(int(SC_USE_CLAMP_TO_BORDER_handGlowTex_tmp)!=0);
float4 param_16=(*sc_set0.UserUniforms).handGlowTexBorderColor;
float param_17=0.0;
...
float3 l9_71=l9_70;
float3 l9_72=l9_71;
float4 l9_73=sc_set0.handGlowTex.sample(sc_set0.handGlowTexSmpSC,l9_72.xy,bias(l9_66));
float4 l9_74=l9_73;
if (param_15)
{
...
float4 param_18=(*sc_set0.UserUniforms).thumbGlowColor;
Output_N15=param_18;
float Value1_N16=0.0;
float Value2_N16=0.0;
float Value3_N16=0.0;
float3 param_19=Output_N15.xyz;
...
float param_23=(*sc_set0.UserUniforms).thumbBrightness;
Output_N10=param_23;
...
float4 param_25=Value_N7;
float4 param_26=Value_N17;
float4 l9_76=param_25;
float4 l9_77=param_26;
float3 l9_78=l9_76.xyz*l9_76.w;
l9_76=float4(l9_78.x,l9_78.y,l9_78.z,l9_76.w);
float4 param_24=l9_76+(l9_77*(1.0-l9_76.w));
Output_N14=param_24;
...
float4 l9_82=fast::max(param_28,float4(0.0));
float4 param_29=l9_82;
if (sc_ShaderCacheConstant_tmp!=0)
{
