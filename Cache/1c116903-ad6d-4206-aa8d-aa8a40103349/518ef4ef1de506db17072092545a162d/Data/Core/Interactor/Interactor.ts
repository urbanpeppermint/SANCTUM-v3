...
export interface Interactor {
  ...
  onTriggerCanceled: PublicApi<Interactable | null>

  currentSecondaryTrigger: InteractorTriggerType
  previousSecondaryTrigger: InteractorTriggerType
  isSecondaryTriggering: boolean
  wasSecondaryTriggering: boolean
  holdTimerProgress: number

  /**
   * Gate event for the hold-based secondary trigger. The hold timer only
   * starts if at least one listener is registered for this event on the
   * target Interactable or any of its ancestors.
   */
  onSecondaryTriggerStart: PublicApi<Interactable | null>
  onSecondaryTriggerUpdate: PublicApi<Interactable | null>
  onSecondaryTriggerEnd: PublicApi<Interactable | null>
  onSecondaryTriggerCanceled: PublicApi<Interactable | null>
