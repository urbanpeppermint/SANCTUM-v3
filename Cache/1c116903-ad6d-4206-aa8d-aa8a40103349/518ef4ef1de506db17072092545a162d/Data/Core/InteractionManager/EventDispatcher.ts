  ...
  private invokeEvent(event: InteractorEvent, eventName: InteractableEventName) {
    ...
    switch (eventName) {
      ...
      case "TriggerCanceled":
        ...
        break
      case "SecondaryTriggerStart":
        interactable.secondaryTriggerStart(event)
        break
      case "SecondaryTriggerUpdate":
        interactable.secondaryTriggerUpdate(event)
        break
      case "SecondaryTriggerEnd":
        interactable.secondaryTriggerEnd(event)
        break
      case "SecondaryTriggerEndOutside":
        interactable.secondaryTriggerEndOutside(event)
        break
      case "SecondaryTriggerCanceled":
        interactable.secondaryTriggerCanceled(event)
        break
      default:
