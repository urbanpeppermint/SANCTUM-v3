...
//}
//ubo int UserUniforms 0:26:4416 {
//float4 sc_Time 1376
...
//float4 baseColor 4256
//float Port_Input1_N012 4288
//float Port_Input1_N013 4292
//float Port_Input0_N023 4296
//float Port_Input1_N032 4300
//float Port_Input0_N030 4304
//float Port_Input1_N031 4308
//float Port_Input1_N016 4312
//float Port_Input1_N015 4316
//float Port_Input0_N046 4320
//float Port_Input1_N046 4324
//float Port_Value_N050 4328
//float3 Port_Input1_N037 4336
//float Port_Input0_N052 4352
//float Port_Input0_N057 4356
//float Port_Input1_N057 4360
//float Port_Input1_N056 4364
//float Port_Input2_N056 4368
//float Port_Input1_N051 4372
//float4 Port_Input1_N042 4384
//float4 Port_Input2_N042 4400
//}
...
Position_N6=Globals.SurfacePosition_ObjectSpace;
float Value1_N7=0.0;
float Value2_N7=0.0;
float Value3_N7=0.0;
float4 param_1=float4(Position_N6,0.0);
...
float Value1_N5=0.0;
float Value3_N5=0.0;
float4 param_5=Color_N3;
float param_6=param_5.x;
float param_7=param_5.z;
Value1_N5=param_6;
Value3_N5=param_7;
...
float3 param_8=float3(length(l9_122[0].xyz),length(l9_122[1].xyz),length(l9_122[2].xyz));
Scale_N2=param_8;
float Value1_N11=0.0;
float Value2_N11=0.0;
float Value3_N11=0.0;
float3 param_9=Scale_N2;
float param_10=param_9.x;
float param_11=param_9.y;
float param_12=param_9.z;
Value1_N11=param_10;
Value2_N11=param_11;
Value3_N11=param_12;
...
int l9_136=l9_135;
l9_134=((*sc_set0.UserUniforms).sc_ModelViewMatrixArray[l9_136]*param_17.position)*float4(1.0/(*sc_set0.UserUniforms).sc_Camera.aspect,1.0,1.0,1.0);
}
else
{
if (sc_RenderingSpace_tmp==2)
...
{
float4 l9_141=param_17.position;
...
{
float4 l9_450=((*sc_set0.UserUniforms).sc_PrevFrameModelMatrix*(*sc_set0.UserUniforms).sc_ModelMatrixInverse)*float4(param_22,1.0);
float3 l9_451=param_22;
