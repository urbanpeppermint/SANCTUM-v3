...
//float3x3 handGlowTexTransform 4432
//float4 handGlowTexUvMinMax 4480
//float4 handGlowTexBorderColor 4496
//float brightness 4512
//float4 Port_Input0_N003 4528
//float depthRef 4544
//}
...
int l9_6=l9_1;
int param_1=handGlowTexLayout_tmp;
int param_2=l9_6;
float2 param_3=UVCoord_N0;
bool param_4=(int(SC_USE_UV_TRANSFORM_handGlowTex_tmp)!=0);
float3x3 param_5=(*sc_set0.UserUniforms).handGlowTexTransform;
int2 param_6=int2(SC_SOFTWARE_WRAP_MODE_U_handGlowTex_tmp,SC_SOFTWARE_WRAP_MODE_V_handGlowTex_tmp);
bool param_7=(int(SC_USE_UV_MIN_MAX_handGlowTex_tmp)!=0);
float4 param_8=(*sc_set0.UserUniforms).handGlowTexUvMinMax;
bool param_9=(int(SC_USE_CLAMP_TO_BORDER_handGlowTex_tmp)!=0);
float4 param_10=(*sc_set0.UserUniforms).handGlowTexBorderColor;
float param_11=0.0;
