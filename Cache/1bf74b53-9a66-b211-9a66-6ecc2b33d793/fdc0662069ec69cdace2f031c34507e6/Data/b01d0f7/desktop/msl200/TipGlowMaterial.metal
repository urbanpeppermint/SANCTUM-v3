...
//float4 tintColor 4384
//float3x3 mainTexTransform 4448
//float4 mainTexUvMinMax 4496
//float4 mainTexBorderColor 4512
//float brightness 4528
//float fadeLevel 4532
//float depthRef 4536
//}
...
float4 param_1=(*sc_set0.UserUniforms).tintColor;
Output_N3=param_1;
...
int l9_6=l9_1;
int param_2=mainTexLayout_tmp;
int param_3=l9_6;
float2 param_4=UVCoord_N2;
bool param_5=(int(SC_USE_UV_TRANSFORM_mainTex_tmp)!=0);
float3x3 param_6=(*sc_set0.UserUniforms).mainTexTransform;
int2 param_7=int2(SC_SOFTWARE_WRAP_MODE_U_mainTex_tmp,SC_SOFTWARE_WRAP_MODE_V_mainTex_tmp);
bool param_8=(int(SC_USE_UV_MIN_MAX_mainTex_tmp)!=0);
float4 param_9=(*sc_set0.UserUniforms).mainTexUvMinMax;
bool param_10=(int(SC_USE_CLAMP_TO_BORDER_mainTex_tmp)!=0);
float4 param_11=(*sc_set0.UserUniforms).mainTexBorderColor;
float param_12=0.0;
