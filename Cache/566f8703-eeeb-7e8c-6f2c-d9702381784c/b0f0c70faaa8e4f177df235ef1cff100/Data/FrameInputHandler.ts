...
export default class FrameInputHandler {
   ...
   */
  readonly onTranslationStart = this.onTranslationStartEvent.publicApi()

  private onTranslationEndEvent = new Event()
  /**
   * Callback for when translation ends
   */
  readonly onTranslationEnd = this.onTranslationEndEvent.publicApi()
  ...
  set isInteractable(isInteractable: boolean) {
