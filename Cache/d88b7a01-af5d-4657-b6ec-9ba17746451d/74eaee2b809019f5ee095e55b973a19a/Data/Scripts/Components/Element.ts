...
export abstract class Element extends BaseScriptComponent {
  ...
  private onInteractableDefault(stateEvent: StateEvent) {
  ...
  private onInteractableHovered(stateEvent: StateEvent) {
  ...
  private onInteractableTriggered(stateEvent: StateEvent) {
  ...
  private onInteractableToggledDefault(stateEvent: StateEvent) {
  ...
  private onInteractableToggledHovered(stateEvent: StateEvent) {
  ...
  private onInteractableToggledTriggered(stateEvent: StateEvent) {
  ...
  protected onHoverEnterHandler(_: StateEvent) {
    this.onHoverEnterEvent.invoke()
  }

  protected onHoverExitHandler(_: StateEvent) {
    this.onHoverExitEvent.invoke()
  }

  protected onTriggerDownHandler(stateEvent: StateEvent) {
