...
export class SphereVisual extends Visual {
  ...
  private _hoverSecondColor: vec4 = SphereColors.hover.second
  private _triggeredSecondColor: vec4 = SphereColors.triggered.base
  private _toggledSecondDefaultColor: vec4 = SphereColors.triggered.base
  private _toggledSecondHoverColor: vec4 = SphereColors.toggledHover.second
  ...
  public set defaultSecondColor(color: vec4) {
    ...
    if (isEqual<vec4>(this._defaultSecondColor, color)) {
      return
    }
  ...
  public set hoverSecondColor(color: vec4) {
    ...
    if (isEqual<vec4>(this._hoverSecondColor, color)) {
      return
    }
   ...
   */
  public set triggeredSecondColor(color: vec4) {
    if (color === undefined) {
      return
    }
    if (isEqual<vec4>(this._triggeredSecondColor, color)) {
      return
    }
  ...
  public set toggledSecondDefaultColor(color: vec4) {
    ...
    if (isEqual<vec4>(this._toggledSecondDefaultColor, color)) {
      return
    }
  ...
  public set toggledSecondHoverColor(color: vec4) {
    ...
    if (isEqual<vec4>(this._toggledSecondHoverColor, color)) {
      return
    }
  ...
  set hoverIcon(icon: Texture) {
    ...
    if (isEqual<Texture>(this._hoverIcon, icon)) {
      return
    }
   ...
   */
  set triggeredIcon(icon: Texture) {
    if (icon === undefined) {
      return
    }
