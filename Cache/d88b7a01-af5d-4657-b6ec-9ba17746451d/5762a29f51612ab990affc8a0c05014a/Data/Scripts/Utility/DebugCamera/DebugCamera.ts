...
import {UNIT_PLANE_MESH_ASSET} from "../Assets"

@component
export class DebugCamera extends BaseScriptComponent {
  @input
  @allowUndefined
  public lookAt: SceneObject
  @input
  public attachToCamera: boolean = false
  ...
  private viewingPlaneMesh: RenderMesh = UNIT_PLANE_MESH_ASSET
