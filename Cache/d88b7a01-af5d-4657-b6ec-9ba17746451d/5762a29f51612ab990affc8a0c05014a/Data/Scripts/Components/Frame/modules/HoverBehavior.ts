...
export default class HoverBehavior {
  ...
  private bindHoverEvents(): void {
    this.unsubscribeList.push(this.interactable.onHoverEnter.add(this.onHoverEnter))
    this.unsubscribeList.push(this.interactable.onHoverExit.add(this.onHoverExit))
    this.unsubscribeList.push(this.interactable.onHoverUpdate.add(this.onHoverUpdated))

    this.unsubscribeList.push(this.interactable.onTriggerEndOutside.add(this.onTriggerEndOutside))
  }
