...
//float Tweak_N15 4512
//float Tweak_N16 4516
//float Tweak_N5 4520
//float4 Tweak_N9 4528
//float Tweak_N10 4544
//float4 Port_Input0_N014 4560
//float4 Port_Input1_N012 4576
//float Port_RangeMinA_N006 4592
//float Port_RangeMaxA_N006 4596
//float Port_RangeMinB_N006 4600
//float Port_RangeMaxB_N006 4604
//float depthRef 4608
//}
...
float4 Tweak_N9;
float Tweak_N10;
float4 Port_Input0_N014;
float4 Port_Input1_N012;
...
float3 l9_87=l9_86;
float3 l9_88=l9_87;
float4 l9_89=sc_set0.Tweak_N1.sample(sc_set0.Tweak_N1SmpSC,l9_88.xy,bias(l9_82));
float4 l9_90=l9_89;
if (param_9)
{
...
Output_N12=dot(Color_N0,(*sc_set0.UserUniforms).Port_Input1_N012);
float Output_N15=0.0;
float param_12=(*sc_set0.UserUniforms).Tweak_N15;
Output_N15=param_12;
float4 Output_N13=float4(0.0);
Output_N13=mix(float4(Output_N12),Color_N0,float4(Output_N15));
float Output_N16=0.0;
float param_13=(*sc_set0.UserUniforms).Tweak_N16;
Output_N16=param_13;
float4 Output_N14=float4(0.0);
Output_N14=mix((*sc_set0.UserUniforms).Port_Input0_N014,Output_N13,float4(Output_N16));
float4 ValueOut_N6=float4(0.0);
ValueOut_N6=(((Output_N14-float4((*sc_set0.UserUniforms).Port_RangeMinA_N006))/float4(((*sc_set0.UserUniforms).Port_RangeMaxA_N006-(*sc_set0.UserUniforms).Port_RangeMinA_N006)+1e-06))*((*sc_set0.UserUniforms).Port_RangeMaxB_N006-(*sc_set0.UserUniforms).Port_RangeMinB_N006))+float4((*sc_set0.UserUniforms).Port_RangeMinB_N006);
float Output_N5=0.0;
float param_14=(*sc_set0.UserUniforms).Tweak_N5;
Output_N5=param_14;
float4 Output_N3=float4(0.0);
Output_N3=ValueOut_N6*float4(Output_N5);
float4 Output_N9=float4(0.0);
float4 param_15=(*sc_set0.UserUniforms).Tweak_N9;
Output_N9=param_15;
float4 Output_N8=float4(0.0);
Output_N8=Output_N3*Output_N9;
float Output_N10=0.0;
float param_16=(*sc_set0.UserUniforms).Tweak_N10;
Output_N10=param_16;
float4 Value_N7=float4(0.0);
Value_N7=float4(Output_N8.xyz.x,Output_N8.xyz.y,Output_N8.xyz.z,Value_N7.w);
Value_N7.w=Output_N10;
FinalColor=Value_N7;
...
float4 l9_95=fast::max(param_18,float4(0.0));
float4 param_19=l9_95;
if (sc_ShaderCacheConstant_tmp!=0)
{
