...
export default class ButtonHandler {
  readonly closeButton: RoundButton
  private closeIcon: Image
  private _closeButtonOffset: vec3 = vec3.zero()
  set closeButtonOffset(value: vec3) {
    if (value === undefined) {
      return
    }
  ...
  constructor(private options: ButtonHandlerConfig) {}
