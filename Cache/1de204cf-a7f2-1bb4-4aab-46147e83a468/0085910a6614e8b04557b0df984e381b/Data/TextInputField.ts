...
const BACKGROUND_GRADIENT_PARAMETERS: {[key: string]: GradientParameters} = {
  toggled: {
    enabled: true,
    type: "Rectangle",
    stop0: {enabled: true, percent: -1, color: COLORS.brightYellow.uniformScale(0.3)},
    stop1: {enabled: true, percent: -1, color: COLORS.brightYellow.uniformScale(0.3)},
    stop2: {enabled: true, percent: -1, color: COLORS.brightYellow.uniformScale(0.3)},
    stop3: {enabled: true, percent: 3, color: COLORS.brightYellow.uniformScale(0.9)}
  },
  default: {
    enabled: true,
    type: "Rectangle",
...
export class TextInputField extends VisualElement {
  ...
  protected onTriggerUpHandler(stateEvent: StateEvent): void {
