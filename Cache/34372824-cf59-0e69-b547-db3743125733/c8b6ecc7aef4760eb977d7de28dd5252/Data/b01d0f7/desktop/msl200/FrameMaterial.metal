...
FinalColor=sc_OutputMotionVectorIfNeeded(param_67,in.varPosAndMotion,in.varNormalAndMotion);
float4 param_68=FinalColor;
float4 l9_196=param_68;
if (sc_ShaderCacheConstant_tmp!=0)
{
