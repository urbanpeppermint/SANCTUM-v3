...
// @input vec3 startInput {"showIf": "movementType", "showIfValue": 0}
// @input vec3 endInput {"showIf": "movementType", "showIfValue": 0}
...
function setupTween() {
    ...
    var transform = script.sceneObjectReference.getTransform();
    ...
    if (!script.manualStart) {
        switch (script.movementType) {
            case 0:
                script.start = (script.type == 2) ? quat.fromEulerAngles(script.startInput.x * DEG_TO_RAD, script.startInput.y * DEG_TO_RAD, script.startInput.z * DEG_TO_RAD) : script.startInput;
                break;
            case 1:
    ...
    if (!script.manualEnd) {
        switch (script.movementType) {
            case 0:
                script.end = (script.type == 2) ? quat.fromEulerAngles(script.endInput.x * DEG_TO_RAD, script.endInput.y * DEG_TO_RAD, script.endInput.z * DEG_TO_RAD) : script.endInput;
                break;
            case 1:
