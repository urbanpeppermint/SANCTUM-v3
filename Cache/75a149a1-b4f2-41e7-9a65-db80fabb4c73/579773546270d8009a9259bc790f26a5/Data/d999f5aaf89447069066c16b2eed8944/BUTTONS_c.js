...
// @input SceneObject meshObject1
// @input SceneObject meshObject2
// @input SceneObject meshObject3
// @input SceneObject meshObject4
// @input SceneObject meshObject5
// @input SceneObject meshObject6
// @input SceneObject meshObject7
// @input float rotationSpeed = 45
...
awakeEvent.bind(() => {
    ...
    checkUndefined("meshObject1", []);
    checkUndefined("meshObject2", []);
    checkUndefined("meshObject3", []);
    checkUndefined("meshObject4", []);
    checkUndefined("meshObject5", []);
    checkUndefined("meshObject6", []);
    checkUndefined("meshObject7", []);
