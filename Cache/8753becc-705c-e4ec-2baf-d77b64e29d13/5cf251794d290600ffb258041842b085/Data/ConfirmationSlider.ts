...
export class ConfirmationSlider extends Slider {
   ...
   */
  set confirmationThreshold(value: number) {
    if (value === undefined) {
      return
    }
    if (value < 0 || value > 1) {
   ...
   */
  get confirmationThreshold(): number {
