...
//sampler sampler screenTextureSmpSC 0:34
...
//texture texture2D screenTexture 0:22:0:34
//ubo float sc_BonesUBO 0:3:96 {
//sc_Bone_t sc_Bones 0:[1]:96
//float4 sc_Bones.boneMatrix 0:[3]:16
//float4 sc_Bones.normalMatrix 48:[3]:16
//}
//ubo int UserUniforms 0:35:4688 {
//float4 sc_Time 1376
...
//float4 screenTextureSize 4384
//float3x3 screenTextureTransform 4432
//float4 screenTextureUvMinMax 4480
//float4 screenTextureBorderColor 4496
//float factor 4512
//float angle 4516
//bool fit 4520
//int samples 4524
//float4 opacityTexSize 4528
//float3x3 opacityTexTransform 4576
//float4 opacityTexUvMinMax 4624
//float4 opacityTexBorderColor 4640
//float opacityblurFactor 4656
//float Port_Value0_N015 4660
//float Port_Value1_N015 4664
//float Port_Value2_N015 4668
//float Port_Default_N015 4672
//float Port_Default_N002 4676
//float Port_Default_N013 4680
//float depthRef 4684
//}
...
//spec_const bool Tweak_N10 40 0
...
//spec_const bool screenTextureHasSwappedViews 76 0
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 77 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_opacityTex 78 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_screenTexture 79 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 80 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_opacityTex 81 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_screenTexture 82 -1
//spec_const int dropdown 83 0
...
//spec_const int screenTextureLayout 93 0
//SG_REFLECTION_END
...
constant bool Tweak_N10 [[function_constant(40)]];
...
constant bool screenTextureHasSwappedViews [[function_constant(76)]];
...
constant int SC_SOFTWARE_WRAP_MODE_U_opacityTex [[function_constant(78)]];
...
constant int SC_SOFTWARE_WRAP_MODE_U_screenTexture [[function_constant(79)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_screenTexture [[function_constant(82)]];
...
constant int dropdown [[function_constant(83)]];
constant int dropdown_tmp = is_function_constant_defined(dropdown) ? dropdown : 0;
...
constant int screenTextureLayout [[function_constant(93)]];
...
float Port_Value0_N015;
float Port_Value1_N015;
float Port_Value2_N015;
float Port_Default_N015;
float Port_Default_N002;
float Port_Default_N013;
float depthRef;
};
struct sc_Bone_t
{
...
texture2d<float> screenTexture [[id(22)]];
...
sampler screenTextureSmpSC [[id(34)]];
...
main_frag_out out={};
bool N5_Fit=false;
float N5_Direction=0.0;
float N5_Factor=0.0;
float N5_Angle=0.0;
float N5_Samples=0.0;
float2 N5_UVs=float2(0.0);
float4 N5_Result=float4(0.0);
bool N8_Fit=false;
float N8_Direction=0.0;
float N8_Factor=0.0;
float N8_Angle=0.0;
float N8_Samples=0.0;
float4 N8_Result=float4(0.0);
...
{
float l9_17=0.0;
float l9_18=(*sc_set0.UserUniforms).Port_Value0_N015;
float l9_19=(*sc_set0.UserUniforms).Port_Value1_N015;
float l9_20=(*sc_set0.UserUniforms).Port_Value2_N015;
float l9_21=(*sc_set0.UserUniforms).Port_Default_N015;
float l9_22;
if (dropdown_tmp==0)
{
l9_22=l9_18;
...
l9_17=l9_22;
float l9_23=0.0;
float l9_24=(*sc_set0.UserUniforms).factor;
l9_23=l9_24;
float l9_25=0.0;
float l9_26=(*sc_set0.UserUniforms).angle;
l9_25=l9_26;
float l9_27=0.0;
float l9_28=0.0;
float l9_29=(*sc_set0.UserUniforms).Port_Default_N002;
float l9_30;
if ((int(Tweak_N10_tmp)!=0))
{
float l9_31=0.0;
float l9_32=float((*sc_set0.UserUniforms).fit!=0);
l9_31=l9_32;
l9_28=l9_31;
l9_30=l9_28;
}
...
float l9_33=0.0;
float l9_34=0.0;
float l9_35=(*sc_set0.UserUniforms).Port_Default_N013;
float l9_36;
if ((int(Tweak_N10_tmp)!=0))
{
float l9_37=0.0;
float l9_38=float((*sc_set0.UserUniforms).samples);
l9_37=l9_38;
l9_34=l9_37;
l9_36=l9_34;
}
...
l9_49=(*sc_set0.UserUniforms).screenTextureSize.xy;
float2 l9_50=l9_49;
float2 l9_51=l9_50;
float2 l9_52=tempGlobals.gScreenCoord;
float2 l9_53=l9_51*l9_52;
float2 l9_54=l9_53/l9_51;
float2 l9_55=l9_53/l9_51;
float l9_56=3.1415927;
tempGlobals.N5_PI=l9_56;
float l9_57=N5_Angle*(tempGlobals.N5_PI/180.0);
float l9_58=l9_51.x/l9_51.y;
float2 l9_59=float2(0.5);
if (N5_Direction==1.0)
{
l9_57*=(-1.0);
}
...
if (N5_Fit)
{
float l9_63=l9_51.y/2.0;
float l9_64=l9_51.x/2.0;
if (l9_63<l9_64)
{
float l9_65=l9_64;
l9_64=l9_63;
...
float l9_66=abs(l9_57);
float l9_67=(l9_63*l9_64)/((l9_64*abs(cos(l9_66)))+(l9_63*sin(l9_66)));
l9_61=l9_67/l9_63;
float l9_68=abs(l9_57/2.0);
float l9_69=(l9_63*l9_64)/((l9_64*abs(cos(l9_68)))+(l9_63*sin(l9_68)));
l9_62=l9_69/l9_63;
}
if (N5_Direction==2.0)
{
...
if ((N5_Direction==0.0)||(N5_Direction==1.0))
{
l9_55.y-=0.0;
l9_55-=float2(0.5);
l9_55.x*=l9_58;
float2 l9_70=l9_55;
float l9_71=l9_57/2.0;
float2 l9_72=l9_70*float2x2(float2(cos(l9_71),-sin(l9_71)),float2(sin(l9_71),cos(l9_71)));
l9_55=l9_72;
l9_55.x*=(1.0/l9_58);
l9_55+=float2(0.5);
}
if (N5_Fit)
{
l9_55=((l9_55-l9_59)*fast::min(l9_61,l9_62))+l9_59;
}
float2 l9_73=l9_55;
...
int l9_80=l9_75;
int l9_81=screenTextureLayout_tmp;
int l9_82=l9_80;
float2 l9_83=l9_73;
bool l9_84=(int(SC_USE_UV_TRANSFORM_screenTexture_tmp)!=0);
float3x3 l9_85=(*sc_set0.UserUniforms).screenTextureTransform;
int2 l9_86=int2(SC_SOFTWARE_WRAP_MODE_U_screenTexture_tmp,SC_SOFTWARE_WRAP_MODE_V_screenTexture_tmp);
bool l9_87=(int(SC_USE_UV_MIN_MAX_screenTexture_tmp)!=0);
float4 l9_88=(*sc_set0.UserUniforms).screenTextureUvMinMax;
bool l9_89=(int(SC_USE_CLAMP_TO_BORDER_screenTexture_tmp)!=0);
float4 l9_90=(*sc_set0.UserUniforms).screenTextureBorderColor;
float l9_91=0.0;
...
float4 l9_158=sc_set0.screenTexture.sample(sc_set0.screenTextureSmpSC,l9_157.xy,bias(l9_151));
...
float2 l9_166=l9_54;
float l9_167=l9_60;
float2 l9_168=l9_166*float2x2(float2(cos(l9_167),-sin(l9_167)),float2(sin(l9_167),cos(l9_167)));
l9_54=l9_168;
l9_54.x*=(1.0/l9_58);
l9_54+=float2(0.5);
if (N5_Fit)
{
l9_54=((l9_54-l9_59)*l9_61)+l9_59;
}
float2 l9_169=l9_54;
...
int l9_175=l9_164;
int l9_176=screenTextureLayout_tmp;
int l9_177=l9_175;
float2 l9_178=l9_169;
bool l9_179=(int(SC_USE_UV_TRANSFORM_screenTexture_tmp)!=0);
float3x3 l9_180=(*sc_set0.UserUniforms).screenTextureTransform;
int2 l9_181=int2(SC_SOFTWARE_WRAP_MODE_U_screenTexture_tmp,SC_SOFTWARE_WRAP_MODE_V_screenTexture_tmp);
bool l9_182=(int(SC_USE_UV_MIN_MAX_screenTexture_tmp)!=0);
float4 l9_183=(*sc_set0.UserUniforms).screenTextureUvMinMax;
bool l9_184=(int(SC_USE_CLAMP_TO_BORDER_screenTexture_tmp)!=0);
float4 l9_185=(*sc_set0.UserUniforms).screenTextureBorderColor;
float l9_186=0.0;
...
float4 l9_253=sc_set0.screenTexture.sample(sc_set0.screenTextureSmpSC,l9_252.xy,bias(l9_246));
...
l9_170=l9_255;
float4 l9_256=l9_170;
l9_163+=l9_256.xyz;
l9_60+=(l9_57/N5_Samples);
l9_165+=1.0;
continue;
}
else
...
l9_163/=float3(N5_Samples);
N5_UVs=l9_55;
N5_Result=float4(mix(l9_162,l9_163,float3(N5_Factor/5.0)),1.0);
l9_47=N5_UVs;
l9_48=N5_Result;
l9_39=l9_47;
l9_40=l9_48;
...
int l9_263=l9_258;
int l9_264=screenTextureLayout_tmp;
int l9_265=l9_263;
float2 l9_266=l9_39;
bool l9_267=(int(SC_USE_UV_TRANSFORM_screenTexture_tmp)!=0);
float3x3 l9_268=(*sc_set0.UserUniforms).screenTextureTransform;
int2 l9_269=int2(SC_SOFTWARE_WRAP_MODE_U_screenTexture_tmp,SC_SOFTWARE_WRAP_MODE_V_screenTexture_tmp);
bool l9_270=(int(SC_USE_UV_MIN_MAX_screenTexture_tmp)!=0);
float4 l9_271=(*sc_set0.UserUniforms).screenTextureUvMinMax;
bool l9_272=(int(SC_USE_CLAMP_TO_BORDER_screenTexture_tmp)!=0);
float4 l9_273=(*sc_set0.UserUniforms).screenTextureBorderColor;
float l9_274=0.0;
...
float4 l9_341=sc_set0.screenTexture.sample(sc_set0.screenTextureSmpSC,l9_340.xy,bias(l9_334));
...
l9_257=l9_343;
float l9_344=0.0;
float l9_345=(*sc_set0.UserUniforms).opacityblurFactor;
l9_344=l9_345;
...
l9_354=(*sc_set0.UserUniforms).opacityTexSize.xy;
float2 l9_355=l9_354;
float2 l9_356=l9_355;
float2 l9_357=tempGlobals.gScreenCoord;
float2 l9_358=l9_356*l9_357;
float2 l9_359=l9_358/l9_356;
float2 l9_360=l9_358/l9_356;
float l9_361=3.1415927;
tempGlobals.N8_PI=l9_361;
float l9_362=N8_Angle*(tempGlobals.N8_PI/180.0);
float l9_363=l9_356.x/l9_356.y;
float2 l9_364=float2(0.5);
if (N8_Direction==1.0)
{
l9_362*=(-1.0);
}
...
if (N8_Fit)
{
float l9_368=l9_356.y/2.0;
float l9_369=l9_356.x/2.0;
if (l9_368<l9_369)
{
float l9_370=l9_369;
l9_369=l9_368;
...
float l9_371=abs(l9_362);
float l9_372=(l9_368*l9_369)/((l9_369*abs(cos(l9_371)))+(l9_368*sin(l9_371)));
l9_366=l9_372/l9_368;
float l9_373=abs(l9_362/2.0);
float l9_374=(l9_368*l9_369)/((l9_369*abs(cos(l9_373)))+(l9_368*sin(l9_373)));
l9_367=l9_374/l9_368;
}
if (N8_Direction==2.0)
{
l9_365=-l9_362;
...
if ((N8_Direction==0.0)||(N8_Direction==1.0))
{
l9_360.y-=0.0;
l9_360-=float2(0.5);
l9_360.x*=l9_363;
float2 l9_375=l9_360;
float l9_376=l9_362/2.0;
float2 l9_377=l9_375*float2x2(float2(cos(l9_376),-sin(l9_376)),float2(sin(l9_376),cos(l9_376)));
l9_360=l9_377;
l9_360.x*=(1.0/l9_363);
l9_360+=float2(0.5);
}
if (N8_Fit)
{
l9_360=((l9_360-l9_364)*fast::min(l9_366,l9_367))+l9_364;
}
float2 l9_378=l9_360;
...
int l9_385=l9_380;
int l9_386=opacityTexLayout_tmp;
int l9_387=l9_385;
float2 l9_388=l9_378;
bool l9_389=(int(SC_USE_UV_TRANSFORM_opacityTex_tmp)!=0);
float3x3 l9_390=(*sc_set0.UserUniforms).opacityTexTransform;
int2 l9_391=int2(SC_SOFTWARE_WRAP_MODE_U_opacityTex_tmp,SC_SOFTWARE_WRAP_MODE_V_opacityTex_tmp);
bool l9_392=(int(SC_USE_UV_MIN_MAX_opacityTex_tmp)!=0);
float4 l9_393=(*sc_set0.UserUniforms).opacityTexUvMinMax;
bool l9_394=(int(SC_USE_CLAMP_TO_BORDER_opacityTex_tmp)!=0);
float4 l9_395=(*sc_set0.UserUniforms).opacityTexBorderColor;
float l9_396=0.0;
...
float4 l9_463=sc_set0.opacityTex.sample(sc_set0.opacityTexSmpSC,l9_462.xy,bias(l9_456));
...
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_470<N8_Samples)
{
l9_359=l9_358/l9_356;
l9_359.y-=0.0;
l9_359-=float2(0.5);
l9_359.x*=l9_363;
float2 l9_471=l9_359;
float l9_472=l9_365;
float2 l9_473=l9_471*float2x2(float2(cos(l9_472),-sin(l9_472)),float2(sin(l9_472),cos(l9_472)));
l9_359=l9_473;
l9_359.x*=(1.0/l9_363);
l9_359+=float2(0.5);
if (N8_Fit)
{
l9_359=((l9_359-l9_364)*l9_366)+l9_364;
}
float2 l9_474=l9_359;
...
int l9_480=l9_469;
int l9_481=opacityTexLayout_tmp;
int l9_482=l9_480;
float2 l9_483=l9_474;
bool l9_484=(int(SC_USE_UV_TRANSFORM_opacityTex_tmp)!=0);
float3x3 l9_485=(*sc_set0.UserUniforms).opacityTexTransform;
int2 l9_486=int2(SC_SOFTWARE_WRAP_MODE_U_opacityTex_tmp,SC_SOFTWARE_WRAP_MODE_V_opacityTex_tmp);
bool l9_487=(int(SC_USE_UV_MIN_MAX_opacityTex_tmp)!=0);
float4 l9_488=(*sc_set0.UserUniforms).opacityTexUvMinMax;
bool l9_489=(int(SC_USE_CLAMP_TO_BORDER_opacityTex_tmp)!=0);
float4 l9_490=(*sc_set0.UserUniforms).opacityTexBorderColor;
float l9_491=0.0;
...
float4 l9_558=sc_set0.opacityTex.sample(sc_set0.opacityTexSmpSC,l9_557.xy,bias(l9_551));
float4 l9_559=l9_558;
if (l9_489)
{
l9_559=mix(l9_490,l9_559,float4(l9_493));
}
float4 l9_560=l9_559;
l9_475=l9_560;
float4 l9_561=l9_475;
l9_468+=l9_561.xyz;
l9_365+=(l9_362/N8_Samples);
l9_470+=1.0;
continue;
}
else
...
l9_468/=float3(N8_Samples);
N8_Result=float4(mix(l9_467,l9_468,float3(N8_Factor/5.0)),1.0);
l9_353=N8_Result;
l9_346=l9_353;
float4 l9_562=float4(0.0);
l9_562=mix(l9_257,l9_40,float4(l9_346.x));
param_1=l9_562;
param_3=param_1;
}
else
{
float l9_563=0.0;
float l9_564=(*sc_set0.UserUniforms).Port_Value0_N015;
float l9_565=(*sc_set0.UserUniforms).Port_Value1_N015;
float l9_566=(*sc_set0.UserUniforms).Port_Value2_N015;
float l9_567=(*sc_set0.UserUniforms).Port_Default_N015;
float l9_568;
if (dropdown_tmp==0)
{
l9_568=l9_564;
...
l9_563=l9_568;
float l9_569=0.0;
float l9_570=(*sc_set0.UserUniforms).factor;
l9_569=l9_570;
float l9_571=0.0;
float l9_572=(*sc_set0.UserUniforms).angle;
l9_571=l9_572;
float l9_573=0.0;
float l9_574=0.0;
float l9_575=(*sc_set0.UserUniforms).Port_Default_N002;
float l9_576;
if ((int(Tweak_N10_tmp)!=0))
{
float l9_577=0.0;
float l9_578=float((*sc_set0.UserUniforms).fit!=0);
l9_577=l9_578;
l9_574=l9_577;
l9_576=l9_574;
}
...
float l9_579=0.0;
float l9_580=0.0;
float l9_581=(*sc_set0.UserUniforms).Port_Default_N013;
float l9_582;
if ((int(Tweak_N10_tmp)!=0))
{
float l9_583=0.0;
float l9_584=float((*sc_set0.UserUniforms).samples);
l9_583=l9_584;
l9_580=l9_583;
l9_582=l9_580;
}
...
l9_593=(*sc_set0.UserUniforms).screenTextureSize.xy;
float2 l9_594=l9_593;
float2 l9_595=l9_594;
float2 l9_596=tempGlobals.gScreenCoord;
float2 l9_597=l9_595*l9_596;
float2 l9_598=l9_597/l9_595;
float2 l9_599=l9_597/l9_595;
float l9_600=3.1415927;
tempGlobals.N5_PI=l9_600;
float l9_601=N5_Angle*(tempGlobals.N5_PI/180.0);
float l9_602=l9_595.x/l9_595.y;
float2 l9_603=float2(0.5);
if (N5_Direction==1.0)
{
l9_601*=(-1.0);
}
...
if (N5_Fit)
{
float l9_607=l9_595.y/2.0;
float l9_608=l9_595.x/2.0;
if (l9_607<l9_608)
{
float l9_609=l9_608;
l9_608=l9_607;
...
float l9_610=abs(l9_601);
float l9_611=(l9_607*l9_608)/((l9_608*abs(cos(l9_610)))+(l9_607*sin(l9_610)));
l9_605=l9_611/l9_607;
float l9_612=abs(l9_601/2.0);
float l9_613=(l9_607*l9_608)/((l9_608*abs(cos(l9_612)))+(l9_607*sin(l9_612)));
l9_606=l9_613/l9_607;
}
if (N5_Direction==2.0)
{
l9_604=-l9_601;
...
l9_599-=float2(0.5);
l9_599.x*=l9_602;
float2 l9_614=l9_599;
float l9_615=l9_601/2.0;
float2 l9_616=l9_614*float2x2(float2(cos(l9_615),-sin(l9_615)),float2(sin(l9_615),cos(l9_615)));
l9_599=l9_616;
l9_599.x*=(1.0/l9_602);
l9_599+=float2(0.5);
}
if (N5_Fit)
{
l9_599=((l9_599-l9_603)*fast::min(l9_605,l9_606))+l9_603;
}
float2 l9_617=l9_599;
...
int l9_624=l9_619;
int l9_625=screenTextureLayout_tmp;
int l9_626=l9_624;
float2 l9_627=l9_617;
bool l9_628=(int(SC_USE_UV_TRANSFORM_screenTexture_tmp)!=0);
float3x3 l9_629=(*sc_set0.UserUniforms).screenTextureTransform;
int2 l9_630=int2(SC_SOFTWARE_WRAP_MODE_U_screenTexture_tmp,SC_SOFTWARE_WRAP_MODE_V_screenTexture_tmp);
bool l9_631=(int(SC_USE_UV_MIN_MAX_screenTexture_tmp)!=0);
float4 l9_632=(*sc_set0.UserUniforms).screenTextureUvMinMax;
bool l9_633=(int(SC_USE_CLAMP_TO_BORDER_screenTexture_tmp)!=0);
float4 l9_634=(*sc_set0.UserUniforms).screenTextureBorderColor;
float l9_635=0.0;
...
float4 l9_702=sc_set0.screenTexture.sample(sc_set0.screenTextureSmpSC,l9_701.xy,bias(l9_695));
float4 l9_703=l9_702;
if (l9_633)
{
l9_703=mix(l9_634,l9_703,float4(l9_637));
}
float4 l9_704=l9_703;
l9_618=l9_704;
float4 l9_705=l9_618;
float3 l9_706=l9_705.xyz;
float3 l9_707=float3(0.0);
int l9_708;
float l9_709=0.0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_709<N5_Samples)
{
l9_598=l9_597/l9_595;
l9_598.y-=0.0;
l9_598-=float2(0.5);
l9_598.x*=l9_602;
float2 l9_710=l9_598;
float l9_711=l9_604;
float2 l9_712=l9_710*float2x2(float2(cos(l9_711),-sin(l9_711)),float2(sin(l9_711),cos(l9_711)));
l9_598=l9_712;
l9_598.x*=(1.0/l9_602);
l9_598+=float2(0.5);
if (N5_Fit)
{
l9_598=((l9_598-l9_603)*l9_605)+l9_603;
}
float2 l9_713=l9_598;
...
int l9_719=l9_708;
int l9_720=screenTextureLayout_tmp;
int l9_721=l9_719;
float2 l9_722=l9_713;
bool l9_723=(int(SC_USE_UV_TRANSFORM_screenTexture_tmp)!=0);
float3x3 l9_724=(*sc_set0.UserUniforms).screenTextureTransform;
int2 l9_725=int2(SC_SOFTWARE_WRAP_MODE_U_screenTexture_tmp,SC_SOFTWARE_WRAP_MODE_V_screenTexture_tmp);
bool l9_726=(int(SC_USE_UV_MIN_MAX_screenTexture_tmp)!=0);
float4 l9_727=(*sc_set0.UserUniforms).screenTextureUvMinMax;
bool l9_728=(int(SC_USE_CLAMP_TO_BORDER_screenTexture_tmp)!=0);
float4 l9_729=(*sc_set0.UserUniforms).screenTextureBorderColor;
float l9_730=0.0;
...
l9_722.y=l9_776;
l9_732=l9_779;
float2 l9_787=l9_722;
int l9_788=l9_720;
int l9_789=l9_721;
float l9_790=l9_730;
float2 l9_791=l9_787;
int l9_792=l9_788;
int l9_793=l9_789;
float3 l9_794=float3(0.0);
if (l9_792==0)
{
l9_794=float3(l9_791,0.0);
}
else
{
if (l9_792==1)
{
l9_794=float3(l9_791.x,(l9_791.y*0.5)+(0.5-(float(l9_793)*0.5)),0.0);
}
else
{
l9_794=float3(l9_791,float(l9_793));
}
}
float3 l9_795=l9_794;
float3 l9_796=l9_795;
float4 l9_797=sc_set0.screenTexture.sample(sc_set0.screenTextureSmpSC,l9_796.xy,bias(l9_790));
float4 l9_798=l9_797;
if (l9_728)
{
l9_798=mix(l9_729,l9_798,float4(l9_732));
}
float4 l9_799=l9_798;
l9_714=l9_799;
float4 l9_800=l9_714;
l9_707+=l9_800.xyz;
l9_604+=(l9_601/N5_Samples);
l9_709+=1.0;
continue;
}
else
...
l9_707/=float3(N5_Samples);
N5_UVs=l9_599;
N5_Result=float4(mix(l9_706,l9_707,float3(N5_Factor/5.0)),1.0);
l9_592=N5_Result;
l9_585=l9_592;
param_2=l9_585;
param_3=param_2;
...
float2 l9_802=floor(mod(l9_801.xy,float2(4.0)));
float l9_803=(mod(dot(l9_802,float2(4.0,1.0))*9.0,16.0)+1.0)/17.0;
if (param_5<l9_803)
{
discard_fragment();
}
...
float4 l9_804=fast::max(param_6,float4(0.0));
float4 param_7=l9_804;
if (sc_ShaderCacheConstant_tmp!=0)
{
...
{
l9_807=(1.0-dot(l9_806.xyz,float3(0.33333001)))*l9_806.w;
}
else
{
...
{
l9_807=dot(l9_806.xyz,float3(0.33333001))*l9_806.w;
}
else
{
...
float l9_808=l9_807;
float l9_809=l9_808;
float l9_810=(*sc_set0.UserUniforms).sc_ShadowDensity*l9_809;
float3 l9_811=mix((*sc_set0.UserUniforms).sc_ShadowColor.xyz,(*sc_set0.UserUniforms).sc_ShadowColor.xyz*l9_805.xyz,float3((*sc_set0.UserUniforms).sc_ShadowColor.w));
...
{
float4 l9_813=param_8;
float4 l9_814=float4(0.0);
float4 l9_815=float4(0.0);
if ((int(sc_FramebufferFetch_tmp)!=0))
{
float4 l9_816=out.sc_FragData0;
l9_815=l9_816;
}
else
{
float4 l9_817=gl_FragCoord;
float2 l9_818=l9_817.xy*(*sc_set0.UserUniforms).sc_CurrentRenderTargetDims.zw;
...
{
l9_822=in.varStereoViewID;
}
int l9_823=l9_822;
int l9_824=l9_823;
float3 l9_825=float3(l9_819,0.0);
int l9_826=l9_821;
int l9_827=l9_824;
if (l9_826==1)
{
l9_825.y=((2.0*l9_825.y)+float(l9_827))-1.0;
}
float2 l9_828=l9_825.xy;
l9_820=l9_828;
}
else
{
...
int l9_839=l9_834;
float2 l9_840=l9_832;
int l9_841=sc_ScreenTextureLayout_tmp;
int l9_842=l9_839;
float l9_843=l9_833;
...
float4 l9_850=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_849.xy,bias(l9_843));
float4 l9_851=l9_850;
float4 l9_852=l9_851;
l9_815=l9_852;
}
float4 l9_853=l9_815;
float3 l9_854=l9_853.xyz;
float3 l9_855=l9_854;
float3 l9_856=l9_813.xyz;
float3 l9_857=definedBlend(l9_855,l9_856,in.varStereoViewID,(*sc_set0.UserUniforms),sc_set0.intensityTexture,sc_set0.intensityTextureSmpSC);
l9_814=float4(l9_857.x,l9_857.y,l9_857.z,l9_814.w);
float3 l9_858=mix(l9_854,l9_814.xyz,float3(l9_813.w));
l9_814=float4(l9_858.x,l9_858.y,l9_858.z,l9_814.w);
l9_814.w=1.0;
float4 l9_859=l9_814;
param_8=l9_859;
}
else
{
if ((int(sc_Voxelization_tmp)!=0))
{
float4 l9_860=float4(in.varScreenPos.xyz,1.0);
param_8=l9_860;
}
else
{
if ((int(sc_OutputBounds_tmp)!=0))
{
float4 l9_861=gl_FragCoord;
float l9_862=fast::clamp(abs(l9_861.z),0.0,1.0);
float4 l9_863=float4(l9_862,1.0-l9_862,1.0,1.0);
param_8=l9_863;
}
else
{
float4 l9_864=param_8;
float4 l9_865=float4(0.0);
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_865=float4(mix(float3(1.0),l9_864.xyz,float3(l9_864.w)),l9_864.w);
}
else
{
if ((int(sc_BlendMode_Screen_tmp)!=0)||(int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
float l9_866=l9_864.w;
if ((int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
l9_866=fast::clamp(l9_866,0.0,1.0);
}
l9_865=float4(l9_864.xyz*l9_866,l9_866);
}
else
{
l9_865=l9_864;
...
float4 l9_871=param_10;
if (sc_ShaderCacheConstant_tmp!=0)
{
l9_871.x+=((*sc_set0.UserUniforms).sc_UniformConstants.x*float(sc_ShaderCacheConstant_tmp));
}
out.sc_FragData0=l9_871;
return out;
}
} // FRAGMENT SHADER
