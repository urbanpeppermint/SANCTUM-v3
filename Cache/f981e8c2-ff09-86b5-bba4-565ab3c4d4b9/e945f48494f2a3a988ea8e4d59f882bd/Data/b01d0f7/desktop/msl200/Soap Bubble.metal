...
//texture texture2D iridescenceMap 0:5:0:26
...
//}
//ubo int UserUniforms 0:39:4976 {
...
//float opacity 4792
//float roughness 4796
//float Port_Input1_N017 4816
//float Port_Input1_N024 4820
//float2 Port_Scale_N057 4824
//float Port_Input1_N058 4832
//float Port_Input2_N060 4840
//float Port_RangeMinA_N063 4848
//float Port_RangeMaxA_N063 4852
//float Port_RangeMinB_N063 4856
//float Port_RangeMaxB_N063 4860
//float Port_RangeMinA_N076 4864
//float Port_RangeMaxA_N076 4868
//float Port_RangeMinB_N076 4872
//float Port_RangeMaxB_N076 4876
//float3 Port_Emissive_N006 4896
//float Port_Metallic_N006 4912
//float3 Port_AO_N006 4928
//float3 Port_SpecularAO_N006 4944
//float depthRef 4960
//}
...
//spec_const bool SC_USE_UV_MIN_MAX_iridescenceMap 34 0
//spec_const bool SC_USE_UV_TRANSFORM_intensityTexture 35 0
//spec_const bool SC_USE_UV_TRANSFORM_iridescenceMap 36 0
//spec_const bool UseViewSpaceDepthVariant 37 1
//spec_const bool intensityTextureHasSwappedViews 38 0
//spec_const bool iridescenceMapHasSwappedViews 39 0
...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_iridescenceMap 82 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 83 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_iridescenceMap 84 -1
//spec_const int intensityTextureLayout 85 0
//spec_const int iridescenceMapLayout 86 0
...
constant bool SC_USE_UV_MIN_MAX_iridescenceMap [[function_constant(34)]];
...
constant bool SC_USE_UV_TRANSFORM_iridescenceMap [[function_constant(36)]];
...
constant bool iridescenceMapHasSwappedViews [[function_constant(39)]];
...
constant int SC_SOFTWARE_WRAP_MODE_U_iridescenceMap [[function_constant(82)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_iridescenceMap [[function_constant(84)]];
...
constant int iridescenceMapLayout [[function_constant(86)]];
...
float2 Port_Scale_N057;
float Port_Input1_N058;
float Port_Import_N059;
float Port_Input2_N060;
...
sampler iridescenceMapSmpSC [[id(26)]];
...
float Output_N9=0.0;
float param_1=(*sc_set0.UserUniforms).Intensity;
Output_N9=param_1;
float Value_N66=0.0;
Value_N66=Output_N9;
float Ratio_N10=0.0;
...
Output_N17=Noise_N16*(*sc_set0.UserUniforms).Port_Input1_N017;
float Output_N24=0.0;
Output_N24=Output_N17-(*sc_set0.UserUniforms).Port_Input1_N024;
float Output_N55=0.0;
Output_N55=Position_N13.z;
float2 Value_N56=float2(0.0);
Value_N56.x=Output_N24;
Value_N56.y=Output_N55;
float Noise_N57=0.0;
float2 param_8=Value_N56;
float2 param_9=(*sc_set0.UserUniforms).Port_Scale_N057;
...
Output_N58=Noise_N57-(*sc_set0.UserUniforms).Port_Input1_N058;
float Output_N43=0.0;
float param_11=(*sc_set0.UserUniforms).noiseIntensity;
Output_N43=param_11;
float Value_N59=0.0;
Value_N59=Output_N43;
float Output_N60=0.0;
Output_N60=(Output_N58*Value_N59)*(*sc_set0.UserUniforms).Port_Input2_N060;
float Output_N61=0.0;
Output_N61=Output_N12+Output_N60;
float Output_N32=0.0;
float param_12=(*sc_set0.UserUniforms).thinFilmWeight;
Output_N32=param_12;
float Value_N62=0.0;
Value_N62=fast::clamp(Output_N32,0.0,1.0);
float ValueOut_N63=0.0;
float param_13=Value_N62;
float param_15=(*sc_set0.UserUniforms).Port_RangeMinA_N063;
float param_16=(*sc_set0.UserUniforms).Port_RangeMaxA_N063;
float param_17=(*sc_set0.UserUniforms).Port_RangeMinB_N063;
float param_18=(*sc_set0.UserUniforms).Port_RangeMaxB_N063;
...
param_14=l9_5;
ValueOut_N63=param_14;
float2 Value_N64=float2(0.0);
Value_N64.x=Output_N61;
Value_N64.y=ValueOut_N63;
float4 Color_N65=float4(0.0);
int l9_6;
...
Color_N65=l9_80;
float Ratio_N75=0.0;
float param_30=dot(Globals.ViewDirWS,Globals.VertexNormal_WorldSpace);
float l9_81=fast::clamp(param_30,0.0,1.0);
Ratio_N75=1.0-l9_81;
float ValueOut_N76=0.0;
float param_31=Ratio_N75;
float param_33=(*sc_set0.UserUniforms).Port_RangeMinA_N076;
float param_34=(*sc_set0.UserUniforms).Port_RangeMaxA_N076;
float param_35=(*sc_set0.UserUniforms).Port_RangeMinB_N076;
float param_36=(*sc_set0.UserUniforms).Port_RangeMaxB_N076;
float param_32=(((param_31-param_33)/((param_34-param_33)+1e-06))*(param_36-param_35))+param_35;
float l9_82;
if (param_36>param_35)
{
l9_82=fast::clamp(param_32,param_35,param_36);
}
else
{
l9_82=fast::clamp(param_32,param_36,param_35);
}
param_32=l9_82;
ValueOut_N76=param_32;
float4 Output_N77=float4(0.0);
Output_N77=(float4(Value_N66)*Color_N65)*float4(ValueOut_N76);
float4 Export_N70=float4(0.0);
Export_N70=Output_N77;
float Output_N0=0.0;
float param_37=(*sc_set0.UserUniforms).opacity;
Output_N0=param_37;
float Output_N1=0.0;
float param_38=(*sc_set0.UserUniforms).roughness;
Output_N1=param_38;
float4 Output_N6=float4(0.0);
float3 param_39=Export_N70.xyz;
float param_40=Output_N0;
float3 param_41=(*sc_set0.UserUniforms).Port_Emissive_N006;
float param_42=(*sc_set0.UserUniforms).Port_Metallic_N006;
float param_43=Output_N1;
float3 param_44=(*sc_set0.UserUniforms).Port_AO_N006;
float3 param_45=(*sc_set0.UserUniforms).Port_SpecularAO_N006;
ssGlobals param_47=Globals;
if (!(int(sc_ProjectiveShadowsCaster_tmp)!=0))
{
param_47.BumpedNormal=param_47.VertexNormal_WorldSpace;
}
param_40=fast::clamp(param_40,0.0,1.0);
float l9_83=param_40;
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
{
if (l9_83<(*sc_set0.UserUniforms).alphaTestThreshold)
{
discard_fragment();
}
}
...
float2 l9_85=floor(mod(l9_84.xy,float2(4.0)));
float l9_86=(mod(dot(l9_85,float2(4.0,1.0))*9.0,16.0)+1.0)/17.0;
if (l9_83<l9_86)
{
discard_fragment();
}
}
param_39=fast::max(param_39,float3(0.0));
float4 param_46;
if ((int(sc_ProjectiveShadowsCaster_tmp)!=0))
{
param_46=float4(param_39,param_40);
}
else
{
param_43=fast::clamp(param_43,0.0,1.0);
float3 l9_87=param_39;
float l9_88=param_40;
float3 l9_89=param_47.BumpedNormal;
float3 l9_90=param_47.PositionWS;
float3 l9_91=param_47.ViewDirWS;
float3 l9_92=param_41;
float l9_93=param_42;
float l9_94=param_43;
float3 l9_95=param_44;
float3 l9_96=param_45;
param_46=ngsCalculateLighting(l9_87,l9_88,l9_89,l9_90,l9_91,l9_92,l9_93,l9_94,l9_95,l9_96,in.varStereoViewID,sc_set0.sc_EnvmapDiffuse,sc_set0.sc_EnvmapDiffuseSmpSC,sc_set0.sc_EnvmapSpecular,sc_set0.sc_EnvmapSpecularSmpSC,sc_set0.sc_ScreenTexture,sc_set0.sc_ScreenTextureSmpSC,sc_set0.sc_RayTracingReflections,sc_set0.sc_RayTracingReflectionsSmpSC,sc_set0.sc_RayTracingGlobalIllumination,sc_set0.sc_RayTracingGlobalIlluminationSmpSC,sc_set0.sc_RayTracingShadows,sc_set0.sc_RayTracingShadowsSmpSC,gl_FragCoord,(*sc_set0.UserUniforms),in.varShadowTex,sc_set0.sc_ShadowTexture,sc_set0.sc_ShadowTextureSmpSC,out.sc_FragData0,sc_set0.sc_SSAOTexture,sc_set0.sc_SSAOTextureSmpSC);
}
param_46=fast::max(param_46,float4(0.0));
Output_N6=param_46;
...
float4 l9_97=fast::max(param_48,float4(0.0));
float4 param_49=l9_97;
if (sc_ShaderCacheConstant_tmp!=0)
{
...
{
float4 l9_106=param_50;
float4 l9_107=float4(0.0);
float4 l9_108=float4(0.0);
if ((int(sc_FramebufferFetch_tmp)!=0))
{
float4 l9_109=out.sc_FragData0;
l9_108=l9_109;
}
else
{
...
float4 l9_146=l9_108;
float3 l9_147=l9_146.xyz;
float3 l9_148=l9_147;
float3 l9_149=l9_106.xyz;
...
l9_107=float4(l9_150.x,l9_150.y,l9_150.z,l9_107.w);
float3 l9_151=mix(l9_147,l9_107.xyz,float3(l9_106.w));
l9_107=float4(l9_151.x,l9_151.y,l9_151.z,l9_107.w);
l9_107.w=1.0;
float4 l9_152=l9_107;
param_50=l9_152;
}
else
{
...
Value_N15=Output_N44;
float Noise_N16=0.0;
float2 param_1=Output_N14;
float2 param_2=Value_N15;
...
Value_N56.x=Output_N24;
Value_N56.y=Output_N55;
float2 param_4=Value_N56;
float2 param_5=(*sc_set0.UserUniforms).Port_Scale_N057;
param_4.x=floor(param_4.x*10000.0)*9.9999997e-05;
param_4.y=floor(param_4.y*10000.0)*9.9999997e-05;
param_4*=(param_5*0.5);
float2 l9_1=param_4;
float Output_N0=0.0;
float param_6=(*sc_set0.UserUniforms).opacity;
Output_N0=param_6;
float Output_N1=0.0;
float param_7=(*sc_set0.UserUniforms).roughness;
Output_N1=param_7;
float param_8=Output_N0;
float param_9=Output_N1;
...
float3 l9_6=param_10.PositionWS;
float3 l9_7=param_10.BumpedNormal;
float l9_8=param_9;
float3 l9_9=l9_6;
float3 l9_10=l9_7;
float l9_11=l9_8;
